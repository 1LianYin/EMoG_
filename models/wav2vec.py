...
def linear_interpolation(features, input_fps, output_fps, output_len=None):
    ...
    output_features = F.interpolate(features,size=output_len,align_corners=True,mode='linear') #torch.Size([128, 512, 34])
...
class Wav2Vec2Model(Wav2Vec2Model):
    ...
    def forward(
        ...
        hidden_states = linear_interpolation(hidden_states, 50, 15, output_len=frame_num) # 30
